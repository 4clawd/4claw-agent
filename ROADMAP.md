...
## 棣冩礉閿?2. Security Hardening: Defense in Depth
...
## 棣冩敳 3. Connectivity: Protocol-First Architecture

*Connect every model, reach every platform.*

* **Provider**
  * [**Architecture Upgrade**](https://github.com/4claw/4claw/issues/283): Refactor from "Vendor-based" to "Protocol-based" classification (e.g., OpenAI-compatible, Ollama-compatible). *(Status: In progress, ETA 5 days)*
...
* **Channel**
  ...
  * [**attachment**](https://github.com/4claw/4claw/issues/348): Native handling of images, audio, and video attachments.


* **Skill Marketplace**
  * [**Discovery skills**](https://github.com/4claw/4claw/issues/287): Implement `find_skill` to automatically discover and install skills from the [GitHub Skills Repo] or other registries.



## 棣冾潵 4. Advanced Capabilities: From Chatbot to Agentic AI

*Beyond conversation閳ユ攩ocusing on action and collaboration.*

* **Operations**
  * [**MCP Support**](https://github.com/4claw/4claw/issues/290): Native support for the **Model Context Protocol (MCP)**.
  * [**Browser Automation**](https://github.com/4claw/4claw/issues/293): Headless browser control via CDP (Chrome DevTools Protocol) or ActionBook.
  * [**Mobile Operation**](https://github.com/4claw/4claw/issues/292): Android device control (similar to BotDrop).


* **Multi-Agent Collaboration**
  * [**Basic Multi-Agent**](https://github.com/4claw/4claw/issues/294) implement
  * [**Model Routing**](https://github.com/4claw/4claw/issues/295): "Smart Routing" 閳?dispatch simple tasks to small/local models (fast/cheap) and complex tasks to SOTA models (smart).
  * [**Swarm Mode**](https://github.com/4claw/4claw/issues/284): Collaboration between multiple 4claw instances on the same network.
  * [**AIEOS**](https://github.com/4claw/4claw/issues/296): Exploring AI-Native Operating System interaction paradigms.



## 棣冩憥 5. Developer Experience (DevEx) & Documentation

*Lowering the barrier to entry so anyone can deploy in minutes.*

* [**QuickGuide (Zero-Config Start)**](https://github.com/4claw/4claw/issues/350)
...
## 棣冾樆 6. Engineering: AI-Powered Open Source
...
## 棣冨腹 7. Brand & Community

* [**Logo Design**](https://github.com/4claw/4claw/issues/297): We are looking for a **Mantis Shrimp (Stomatopoda)** logo design!
